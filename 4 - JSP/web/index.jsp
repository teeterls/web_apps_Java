...
<head>
    ...
    <meta name="description" content="Práctica 6-Programación Aplicaciones Telemáticas">
...
<body>
    ...
    <form action= "index-response.jsp" method="POST" onsubmit="return Validar()"; onreset="BorrarError();">
